    ...
    namespace JHP4SD.GumRuntimes.LebegForms.BasicComponents
    {
        public partial class ToggleButton1Runtime : JHP4SD.GumRuntimes.ContainerRuntime
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (JHP4SD.GumRuntimes.LebegForms.BasicComponents.ToggleButton1Runtime.VariableState fromState,JHP4SD.GumRuntimes.LebegForms.BasicComponents.ToggleButton1Runtime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            	...
            	: base(false, tryCreateFormsObject)
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "LebegForms/BasicComponents/ToggleButton1");
