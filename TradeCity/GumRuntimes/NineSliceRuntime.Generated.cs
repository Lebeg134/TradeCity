    ...
    namespace JHP4SD.GumRuntimes
    {
        public partial class NineSliceRuntime : Gum.Wireframe.GraphicalUiElement
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (JHP4SD.GumRuntimes.NineSliceRuntime.VariableState fromState,JHP4SD.GumRuntimes.NineSliceRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
