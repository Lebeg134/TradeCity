    ...
    {
        public partial class CityGumRuntime : Gum.Wireframe.GraphicalUiElement
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            SetProperty("SpriteInstance.SourceFile", "../GlobalContent/Screen/CityBackground.jpg");
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (JHP4SD.GumRuntimes.CityGumRuntime.VariableState fromState,JHP4SD.GumRuntimes.CityGumRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public CityGumRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            {
                ...
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Screens.First(item => item.Name == "CityGum");
            ...
            public JHP4SD.FormsControls.Screens.CityGumForms FormsControl {get => (JHP4SD.FormsControls.Screens.CityGumForms) FormsControlAsObject;}
        }
    }
