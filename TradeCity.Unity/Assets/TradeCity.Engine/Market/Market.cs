...
namespace TradeCity.Engine.Market
{
    ...
    public class Market : ITickable
    {
        ...
        public int PostListing(ISellable wantSellable, ISellable forSellable, Player by, int amount = 1,
            bool all = false)
        {
        ...
        public List<Listing> GetPlayerListingsList(Player player)
        {
            ...
            foreach (var list in _listings.Values) myListings.AddRange(list.FindAll(x => x.Poster.Equals(player)));
            return myListings;
        }
