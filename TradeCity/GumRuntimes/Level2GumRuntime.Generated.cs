                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            CircleInstance.X = 179f;
                            CircleInstance.Y = 130f;
                            break;
                    }
                }
            }
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        CircleInstanceXFirstValue = 179f;
                        setCircleInstanceYFirstValue = true;
                        CircleInstanceYFirstValue = 130f;
                        break;
                }
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        CircleInstanceXSecondValue = 179f;
                        setCircleInstanceYSecondValue = true;
                        CircleInstanceYSecondValue = 130f;
                        break;
                }
