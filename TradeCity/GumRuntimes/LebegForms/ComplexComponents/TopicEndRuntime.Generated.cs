    ...
    {
        public partial class TopicEndRuntime : JHP4SD.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            RectangleInstance.Height = 100f;
                            RectangleInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.Percentage;
                            ...
                            RectangleInstance.YOrigin = RenderingLibrary.Graphics.VerticalAlignment.Bottom;
                            break;
                    }
                }
            }
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        RectangleInstanceHeightFirstValue = 100f;
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.Percentage;
                        }
                        ...
                        if (interpolationValue < 1)
                        {
                            this.RectangleInstance.YOrigin = RenderingLibrary.Graphics.VerticalAlignment.Bottom;
                        }
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        RectangleInstanceHeightSecondValue = 100f;
                        if (interpolationValue >= 1)
                        {
                            this.RectangleInstance.HeightUnits = Gum.DataTypes.DimensionUnitType.Percentage;
                        }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (JHP4SD.GumRuntimes.LebegForms.ComplexComponents.TopicEndRuntime.VariableState fromState,JHP4SD.GumRuntimes.LebegForms.ComplexComponents.TopicEndRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                ...
                switch(state)
                {
                    case  VariableState.Default:
                        ...
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
                            ...
                            Name = "RectangleInstance.Height",
                            Type = "float",
                            Value = RectangleInstance.Height + 100f
                        }
                        );
                        newState.Variables.Add(new Gum.DataTypes.Variables.VariableSave()
                        {
            ...
            public TopicEndRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                if (fullInstantiation)
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "LebegForms/ComplexComponents/TopicEnd");
