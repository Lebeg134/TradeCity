...
namespace TradeCity.Engine.Session
{
    public static class SessionGenerator
    {
        ...
        public static Session GenerateStandard()
        {
            ...
            foreach (var m in newSession.Missions) m.Accept(Player.CurrentPlayer);
        ...
        private static IEnumerable<Mission> GenerateMissions()
        {
        ...
        {
            return _allBuildings ??= new List<Building>
            {
                new SteelForge(),
